...
class NativeModule(BaseModule):
    def __init__(self):
        ...
        self.info.name = "Tcp Listener"
        self.info.module_name = "native/tcp_listener"
        self.info.command = "tcp_listener"
        self.info.description = "Set up a TCP listener for incoming connections."
